...
INSERT INTO `agents` VALUES (1,'Sue Roberts','0873369854','555-1234','sue@litrealty.ie','Sue.Roberts','ba1e9ece69a4e16d16917e649d517226b9b6b282fbb912bb68fc69f24b80fe61','1','admin'),(2,'Natasha Watkins','555-1357','555-9875','tasha@litreality.ie','Natasha.Watkins','c5365dd9e63a02ffb495b7ddfbf976cda085c7a3e7ba24a0ff3d256fcf5ecb8c','2','agent'),(3,'Chris Clarkson','555-2468','555-6767','chris@litreality.ie','Chris.Clarkson','4CF9F10FD304DC885A78E29A95A77DD552CA15E168C06AD62F53830C1E19B929','3','agent'),(4,'Laura Blain','555-9898','555-6768','laura@litreality.ie','Laura.Blain','F828CBFDF7536D8B23219629263021785F4B48390C7F1CB47449418CFF378E9D','4','agent'),(5,'Dave Lindale','555-8833','555-9876','dave@litreality.ie','Dave.Lindale','C0AB909F6A88E98D9E6891DA2013064CC99B51178689431AC2EA1EBCC4720EAE','5','agent');
...
CREATE TABLE `properties` (
  ...
  `berRating` varchar(2) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_properties_agents_idx1` (`agentId`),
  KEY `fk_properties_garagetypes1_idx1` (`garageId`),
  KEY `fk_properties_styles1_idx1` (`styleId`),
  KEY `fk_properties_status1_idx` (`statusId`),
  KEY `fk_properties_propertytypes1_idx1` (`typeId`),
  ...
  CONSTRAINT `fk_properties_garagetypes1` FOREIGN KEY (`garageId`) REFERENCES `garagetypes` (`garageId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_properties_propertytypes1` FOREIGN KEY (`typeId`) REFERENCES `propertytypes` (`typeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_properties_status1` FOREIGN KEY (`statusId`) REFERENCES `propertystatus` (`statusId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_properties_styles1` FOREIGN KEY (`styleId`) REFERENCES `styles` (`styleId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_vendor` FOREIGN KEY (`vendorId`) REFERENCES `vendors` (`vendorId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `propertystatus` VALUES (1,'Sold'),(2,'Sale Agreed'),(3,'For Sale');
...
INSERT INTO `vendors` VALUES (1,'Ronan Gately','0834446641','ronan@gately.ie'),(2,'Alan Ryan','0873316497','alan@ryan.com'),(3,'Daniel Malone','0859989863','dan@malone.com'),(4,'Cian Geoghegan','0613496157','cian@geoghegan.com'),(5,'Thomas Lambert','0906421469','thom@lambert.ie'),(6,'Mark','Franklin','mark@f.com');
...
-- Dump completed on 2018-02-01 16:19:08
