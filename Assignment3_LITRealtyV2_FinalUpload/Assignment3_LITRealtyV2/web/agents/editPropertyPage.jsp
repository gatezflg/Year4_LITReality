        ...
        <div class="panel-body">
            ...
            <div class="col-lg-9 col-sm-8 " style="padding-bottom: 50px;">
                ...
                <form action="UpdatePropertyServlet?propId=${editProp.id}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <c:choose>
                        <c:when test="${agent.role == 'agent'}">
                            <div class="form-group">
                                <label class="left-control-label col-md-3 col-sm-3 col-xs-12" for="active">
                                    Is Property Active?:
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="active" id="style" class="left-form-control" disabled="true">
                                        <option value="${status.statusId}" selected="selected">${status.status}</option>
                        ...
                        <c:otherwise>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="active" id="style" class="left-form-control" onchange="choice1(this)">
                                        <option value="${status.statusId}" selected="selected">${status.status}</option>
                                        <option value="1">Yes</option>
                                        <option value="0">No</option>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="agent" id="agent" class="right-form-control">
                                    <c:forEach items="${allAgentsList}" var="agent">
                                        <c:choose>
...
function choice1(select) {
     alert("Selecting 'No' will remove this property from customers view");
}
</script>
