            ...
            <div class="col-lg-3 col-sm-4 hidden-xs">
                ...
                <div class="advertisement">
                    <h4>Area Information</h4>
                                <a class="twitter-timeline"  href="https://twitter.com/hashtag/${city}" data-screen-name="${city}" data-aria-polite="assertive" data-widget-id="959048100349440000">#${city} Tweets</a>
                    ...
                    <div class="col-lg-4">
                        <div class="col-lg-12  col-sm-6">
                            <div class="property-info">
                                ...
                                <h6><span class="glyphicon glyphicon-home"></span> Property Details</h6>
                                <div class="listing-detail">
                                    <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bedrooms">${property.bedrooms}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bathrooms">${property.bathrooms}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">${property.garagesize}</span> 
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Listing Number: </label>
                                    <span class="pull-right">${property.listingNum}</span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Status </label>
                                    <span class="pull-right">${property.statusId.status}</span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Date Added: </label>
                                    <span class="pull-right"><fmt:formatDate pattern="dd-MM-yyyy" value="${property.dateAdded}" /></span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Property Type:  </label>
                                    <span class="pull-right">${property.typeId.PType} </span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Property Style: </label>
                                    <span class="pull-right">${property.styleId.PStyle}</span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Lot Size: </label>
                                    <span class="pull-right">${property.lotsize}</span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Sq Foot: </label>
                                    <span class="pull-right">${property.squarefeet}</span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">Garage Type:</label>
                                    <span class="pull-right">${property.garageId.GType}</span>
                                </div>
                                <div class="input-w">
                                    <label class="your-input">BER Rating:</label>
                                    <span class="pull-right"><img src="images/BER/${property.berRating}.png"/></span>
                                </div>
