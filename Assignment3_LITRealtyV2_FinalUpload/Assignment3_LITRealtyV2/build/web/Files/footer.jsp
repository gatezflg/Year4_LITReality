    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                <h4>Contact us</h4>
                <p><b>LITRealty</b><br>
                    <span class="glyphicon glyphicon-map-marker"></span><span id="litAddress">Limerick Institute of Technology </span> <br>
                    Old Cratloe Rd, Limerick<br>
                    <span class="glyphicon glyphicon-envelope"></span> K00201571@student.lit.ie<br>
