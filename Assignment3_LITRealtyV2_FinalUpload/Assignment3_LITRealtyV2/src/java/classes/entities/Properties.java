...
@NamedQueries({
    ...
    , @NamedQuery(name = "Properties.findAllOrdered", query = "SELECT p FROM Properties p Where p.active = 1 ORDER BY p.city ASC")
    , @NamedQuery(name = "Properties.findRecommended", query = "SELECT p FROM Properties p Where p.active = 1 ORDER BY p.price DESC")
    ...
    , @NamedQuery(name = "Properties.findLatestProperties", query = "SELECT p FROM Properties p Where p.active = 1 AND p.dateAdded > :oneWeekAgo")
