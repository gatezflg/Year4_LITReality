CREATE DATABASE  IF NOT EXISTS `litrealty` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `litrealty`;
...
CREATE TABLE `properties` (
  ...
  KEY `fk_properties_propertytypes1_idx` (`typeId`),
  KEY `fk_properties_styles1_idx` (`styleId`),
  KEY `fk_properties_garagetypes1_idx` (`garageId`)
...
-- Dump completed on 2017-12-07 21:22:43
